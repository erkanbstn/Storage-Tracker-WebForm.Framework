<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Devexpress_Technical_Project_Web.Default" %>
...
<html lang="zxx">
<head>
    <title>Teknik Servis Elektronik Otomasyon</title>
...
<body>
    <div class="sidenav">
		...
		<div class="col-4 side_top_left">
			<img src="web/images/c3.png" alt="news image" class="img-fluid navimg">
		</div>
		<div class="col-8 side_top_right">
			<h6>Teknik Servis </h6>
			<p>Ürün Takip Otomasyon</p>
		</div>
		</div>
       <header>
        ...
        <div class="banner-text-w3ls">
            <div class="container">
                <div class="mx-auto text-center">
                    <h1>En Ucuz Fiyatlarla
	<br>En Uygun Yüzlerce Ürün Bir Tıkla Kapınızda.</h1>
...
<section class="slide-wrapper" id="about">
	...
	<img src="web/images/w1.jpg" class="img-fluid" alt="">
	<p class="iner mt-5">
...
<!-- //about -->
       ...
       <div class="news" id="gallery">
        ...
        <tbody>
            ...
            <ItemTemplate> 
              <tr> <td><%#Eval("ID") %></td>   <td><%#Eval("Ad") %></td>  <td><%#Eval("Marka") %></td> <td><%#Eval("SatışFiyat") %></td> </tr>
    ...
    <div class="wthree_pvtits-services align-w3" id="services">
        <div class="container">
            <div class="wthree_pvt_title text-center">
                ...
                <p class="main_p mb-5  text-center mx-auto">Mağazamızdan Almış Olduğunuz Ürünlerde Herhangi Bir Teknik Problem 2 Yıl Süreyle Onarım Ve Entegre İşlemlerini Yapmaktayız.</p>
                <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" href="WebForm1.aspx" role="button" style="background-color:turquoise">Arızalı Ürün Takibi</a>
            </div>
            <div class="wthree_pvtits-services-row row">
                ...
                <div class="col-lg-4 col-md-6 wthree_sgrid  py-sm-5 py-4">
                    ...
                    <h4 class="my-3">Güvenilir Tesliam </h4>
                </div>
                <div class="col-lg-4 col-md-6 wthree_sgrid   py-sm-5 py-4">
...
<!-- contact -->
	 <section class="wedo" id="contact">
		   ...
		   <p class="main_p mb-5  text-center mx-auto">Aldığınız Herhangi Bir Üründe Sorun Oluşursa Bize Aşağıdaki Panelden Ulaşabilirsiniz. Mailinize En Kısa Sürede Dönüş Yapılacaktır.<p/>
				...
				<form action="#" method="post" runat="server">
					<div class="row contact_top">
						...
						<div class="col-sm-6">
						 ...
						 <asp:TextBox ID="TextBox3" runat="server" placeholder="Arıza Başlığı"></asp:TextBox >
					
                    <asp:TextBox ID="TextBox4" runat="server" TextMode="MultiLine" placeholder="Mesaj...">

                    </asp:TextBox><asp:Button ID="Button1" runat="server" Text="Mesaj Gönder" OnClick="Button1_Click" />
				</form>
			</div>
